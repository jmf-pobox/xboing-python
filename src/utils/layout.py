...
class GameLayout:
    ...
    def _create_windows(self):
        ...
        self.level_window = GameWindow(
            Rect(score_width + offsetX + 25, 5, 
                 self.PLAY_WIDTH + offsetX - 20 - score_width, 52),
            name="levelWindow",
            parent=self.main_window,
            bg_color=None  # Transparent/parent background
        )
        ...
        self.mess_window = GameWindow(
            Rect(offsetX, 65 + self.PLAY_HEIGHT + 10, 
                 self.PLAY_WIDTH // 2, mess_height),
            name="messWindow",
            parent=self.main_window,
            bg_color=None  # Transparent/parent background
        )
        ...
        self.special_window = GameWindow(
            Rect(offsetX + self.PLAY_WIDTH // 2 + 10, 65 + self.PLAY_HEIGHT + 10, 
                 180, mess_height + 5),
            name="specialWindow",
            parent=self.main_window,
            bg_color=None  # Transparent/parent background
        ...
        self.time_window = GameWindow(
            Rect(offsetX + self.PLAY_WIDTH // 2 + 10 + 180 + 5, 
                 65 + self.PLAY_HEIGHT + 10, self.PLAY_WIDTH // 8, mess_height + 5),
            name="timeWindow",
            parent=self.main_window,
            bg_color=None  # Transparent/parent background
        )
    ...
    def load_backgrounds(self, background_dir=None):
        ...
        try:
            ...
            if os.path.exists(space_path):
                ...
                print(f"Using fallback color for main background (space.png not found)")
            ...
            if os.path.exists(bg_path):
                ...
                print(f"Using fallback color for play background (bgrnd.png not found)")
