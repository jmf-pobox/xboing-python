...
class SpriteBlock:
    ...
    BLOCK_IMAGES: Dict[int, Tuple[str, int, int]] = {
        ...
        TYPE_BLUE: ("blueblk.png", 110, BEHAVIOR_NORMAL),
        TYPE_GREEN: ("grnblk.png", 120, BEHAVIOR_NORMAL),
        TYPE_TAN: ("tanblk.png", 130, BEHAVIOR_NORMAL),
        TYPE_YELLOW: ("yellblk.png", 140, BEHAVIOR_NORMAL),
        TYPE_PURPLE: ("purpblk.png", 150, BEHAVIOR_NORMAL),
        TYPE_BULLET: ("bltblk.png", 50, BEHAVIOR_SPECIAL),
        TYPE_BLACK: ("blakblk.png", 0, BEHAVIOR_UNBREAKABLE),
        TYPE_COUNTER: ("cntblk.png", 200, BEHAVIOR_COUNTER),
        TYPE_BOMB: ("bombblk.png", 50, BEHAVIOR_SPECIAL),
        TYPE_DEATH: ("death1.png", 0, BEHAVIOR_DAMAGE),
        TYPE_REVERSE: ("reverse.png", 100, BEHAVIOR_SPECIAL),
        TYPE_HYPERSPACE: ("hypspc.png", 100, BEHAVIOR_SPECIAL),
        TYPE_EXTRABALL: ("xtrabal.png", 100, BEHAVIOR_SPECIAL),
        TYPE_MGUN: ("machgun.png", 100, BEHAVIOR_SPECIAL),
        TYPE_WALLOFF: ("walloff.png", 100, BEHAVIOR_SPECIAL),
        TYPE_MULTIBALL: ("multibal.png", 100, BEHAVIOR_SPECIAL),
        TYPE_STICKY: ("stkyblk.png", 100, BEHAVIOR_SPECIAL),
        TYPE_PAD_SHRINK: ("padshrk.png", 100, BEHAVIOR_SPECIAL),
        TYPE_PAD_EXPAND: ("padexpn.png", 100, BEHAVIOR_SPECIAL),
        TYPE_DROP: ("bonus2.png", 0, BEHAVIOR_SPECIAL),
        TYPE_MAXAMMO: ("lotsammo.png", 50, BEHAVIOR_SPECIAL),
        TYPE_ROAMER: ("roamer.png", 400, BEHAVIOR_DYNAMIC),
        TYPE_TIMER: ("clock.png", 100, BEHAVIOR_SPECIAL),
        TYPE_RANDOM: ("bonus3.png", 0, BEHAVIOR_SPECIAL),
        TYPE_DYNAMITE: ("dynamite.png", 0, BEHAVIOR_SPECIAL),
        TYPE_BONUSX2: ("x2bonus1.png", 0, BEHAVIOR_SPECIAL),
        TYPE_BONUSX4: ("x4bonus1.png", 0, BEHAVIOR_SPECIAL),
        TYPE_BONUS: ("bonus1.png", 0, BEHAVIOR_SPECIAL),
        TYPE_BLACKHIT: ("blakblkH.png", 0, BEHAVIOR_NORMAL),
    }
