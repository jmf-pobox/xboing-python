...
class Paddle:
    ...
    def __init__(self, x, y, width, height, speed=10):
        ...
        self.height = height
        self.speed = speed
        self.size = self.SIZE_LARGE  # Start with the large paddle to match original game
        self.moving = False
    ...
    def _load_sprites(self):
        ...
        try:
            ...
            logger.info(f"Paddle dimensions - Small: {self.paddle_dimensions[self.SIZE_SMALL]}, "
            ...
            logger.warning("Falling back to simple rectangle paddles with original dimensions")
