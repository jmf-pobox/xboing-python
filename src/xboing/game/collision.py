...
class CollisionSystem:
    ...
    def __init__(self, screen_width: int = 0, screen_height: int = 0) -> None:
        ...
        self.collision_handlers: Dict[
            Tuple[str, str], Callable[[Any, Any], List[pygame.event.Event]]
        ] = {}
    ...
    def register_collision_handler(
        ...
        type1: str,
        type2: str,
        handler: Callable[[Any, Any], List[pygame.event.Event]],
    ) -> None:
        """
        ...
        Args:
            ...
            handler: Function to handle the collision and return events.
    ...
    def handle_collision(
        self, obj1: Collidable, obj2: Collidable
        ...
        Returns:
            List of events returned by the collision handler.
    ...
    def check_collisions(
        self,
    ) -> tuple[List[Tuple[Collidable, Collidable]], List[pygame.event.Event]]:
        """
        ...
        Returns:
            ...
            - A list of events generated by collision handlers
        ...
        for i, obj1 in enumerate(self.collidables):
            for obj2 in self.collidables[i + 1 :]:
                if obj1.collides_with(obj2):
                    ...
                    collision_events = self.handle_collision(obj1, obj2)
