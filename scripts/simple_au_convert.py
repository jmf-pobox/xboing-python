...
def main():
    parser = argparse.ArgumentParser(description='Convert .au audio files to .wav format')
    parser.add_argument('--input', '-i', default='../sounds',
                       help='Input directory containing .au files')
    parser.add_argument('--output', '-o', default='../src/assets/sounds',
